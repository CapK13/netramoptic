 ...
 const renderDropdown = (label, name, options, selectedValue, onSelect) => {
  ...
  return (
    <div className="mb-4">
      ...
      <button
        ...
        className={`w-full flex justify-between items-center font-semibold py-2 px-4 rounded transition ${
          isFiltered
      ...
      <div
        className={`transition-all duration-300 overflow-hidden ${
          activeDropdown === name ? 'max-h-96 mt-2' : 'max-h-0'
        }`}
      >
        <div
          className={`${
  ...
  return (
    <div className="min-h-screen w-full flex bg-gray-100 transition-all duration-300">
      {/* Sidebar */}
    <div
  className={`fixed top-0 left-0 h-screen w-1/4 max-md:w-full bg-gray-900 shadow-md z-30 transition-all duration-300 transform ${
  ...
  {[
    ...
    return (
      ...
      >
        {/* Main Button */}
        <button
          className={`flex items-center justify-between w-full px-4 py-2 text-sm font-medium border rounded-lg bg-white transition-all duration-200 shadow-sm hover:shadow-md ${
            filter !== 'all'
        ...
        >
          ...
          <i
            className={`fas fa-chevron-down ml-2 transition-transform duration-200 ${
              open ? 'rotate-180 text-red-600' : 'rotate-0 text-gray-500'
            }`}
          />
        </button>
              ...
              {options.map((opt) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center justify-between px-5 py-3 text-left text-sm transition ${
                      isActive ? 'bg-red-600 text-white' : 'text-gray-800 hover:bg-red-100'
                    }`}
                  >
                    <span className="truncate">
